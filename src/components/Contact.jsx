...
function Contact() {
  ...
  const onSubmit = async(data) => {
    ...
    try {
       await axios.post("https://getform.io/f/apjpokka", userInfo);
  ...
  return (
   ...
   <div name = "Contact"
     ...
     <div className='flex flex-col items-center justify-center mt-5'>
        ...
        // action="https://getform.io/f/apjpokka"
        // method='POST'
         className='bg-slate-200 w-96 px-8 py-6 rounded-xl'>
            ...
            <div className='flex flex-col mb-4'>
                <label className='block text-gray-700 text-sm'>Messages</label>
                <textarea 
            ...
            <button type="submit" className='bg-black text-white rounded-lg px-4 py-2 hover:bg-slate-700 duration-300 ml-30'>Send</button>
        </form>
     </div>
   </div>
